...
Version  : 1.6.1
Release  : 14
URL      : https://files.pythonhosted.org/packages/9b/52/29d5ed1dd3eaa5c12a66c25e76a690143582d1f701a6431dd88f81dd7fc5/debugpy-1.6.1.zip
Source0  : https://files.pythonhosted.org/packages/9b/52/29d5ed1dd3eaa5c12a66c25e76a690143582d1f701a6431dd88f81dd7fc5/debugpy-1.6.1.zip
...
%prep
%setup -q -n debugpy-1.6.1
cd %{_builddir}/debugpy-1.6.1
pushd ..
cp -a debugpy-1.6.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657204676
...
cp %{_builddir}/debugpy-1.6.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-debugpy/bdaa8bcf57470fae2e892cd2848a7aba3664edf6
cp %{_builddir}/debugpy-1.6.1/src/debugpy/_vendored/pydevd/_pydevd_frame_eval/vendored/bytecode-0.13.0.dev0.dist-info/COPYING %{buildroot}/usr/share/package-licenses/pypi-debugpy/7d73b90c1964aabb829818f09bab6a02539765c6
