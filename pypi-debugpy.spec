...
Source0  : https://files.pythonhosted.org/packages/b2/c9/9d585d711cdcae0db7788731b331dab0d1f600d0204e76b2a5c6b30d569e/debugpy-1.8.2.zip
...
%prep
%setup -q -n debugpy-1.8.2
cd %{_builddir}/debugpy-1.8.2
pushd ..
cp -a debugpy-1.8.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719416044
