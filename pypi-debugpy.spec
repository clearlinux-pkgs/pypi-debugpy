...
Source0  : https://files.pythonhosted.org/packages/68/8a/aba73af65eb84e0c61c658d2aa2f2a9b4d2939a7f87294dd396f4987efac/debugpy-1.5.1.zip
...
Provides: debugpy
Provides: debugpy-python
Provides: debugpy-python3
...
%prep
%setup -q -n debugpy-1.5.1
cd %{_builddir}/debugpy-1.5.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641431494
...
cp %{_builddir}/debugpy-1.5.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-debugpy/bdaa8bcf57470fae2e892cd2848a7aba3664edf6
cp %{_builddir}/debugpy-1.5.1/src/debugpy/_vendored/pydevd/_pydevd_frame_eval/vendored/bytecode-0.13.0.dev0.dist-info/COPYING %{buildroot}/usr/share/package-licenses/pypi-debugpy/7d73b90c1964aabb829818f09bab6a02539765c6
