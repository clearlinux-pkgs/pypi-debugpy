...
Source0  : https://files.pythonhosted.org/packages/51/d4/f35f539e11c9344652f362c22413ec5078f677ac71229dc9b4f6f85ccaa3/debugpy-1.8.13.tar.gz
...
%prep
%setup -q -n debugpy-1.8.13
cd %{_builddir}/debugpy-1.8.13
pushd ..
cp -a debugpy-1.8.13 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741203493
