...
Source0  : https://files.pythonhosted.org/packages/27/bf/5fb58a315f33860448ebe6481ec6bf15d67fe783e1f80f6c0868fa284f4d/debugpy-1.6.5.zip
...
%prep
%setup -q -n debugpy-1.6.5
cd %{_builddir}/debugpy-1.6.5
pushd ..
cp -a debugpy-1.6.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672969101
