...
Source0  : https://files.pythonhosted.org/packages/68/25/c74e337134edf55c4dfc9af579eccb45af2393c40960e2795a94351e8140/debugpy-1.8.12.tar.gz
...
%prep
%setup -q -n debugpy-1.8.12
cd %{_builddir}/debugpy-1.8.12
pushd ..
cp -a debugpy-1.8.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737057525
