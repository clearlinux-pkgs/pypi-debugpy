...
Source0  : https://files.pythonhosted.org/packages/bd/75/087fe07d40f490a78782ff3b0a30e3968936854105487decdb33446d4b0e/debugpy-1.8.14.tar.gz
...
%prep
%setup -q -n debugpy-1.8.14
cd %{_builddir}/debugpy-1.8.14
pushd ..
cp -a debugpy-1.8.14 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744381861
